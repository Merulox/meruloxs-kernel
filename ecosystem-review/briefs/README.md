...
| AP-03 | `briefed` | Live log streaming + AI activity summaries | Replace 5s polling with SSE; add one-line Claude summary per running job | aperture | Claude API call per job per 15s |
